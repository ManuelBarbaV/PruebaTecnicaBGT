...
/**
 * Tabla que almacena la auditoria de listasTiposGeneros.
 * @author Manuel Fernando Barba Villamizar
 * @see pruebaTecnicaBog.pruebaTecnicaBog.models.ListasTiposGeneros
 */

@Document(collection = "listasTiposGenerosAUD")
public class ListasTiposGenerosAud {
    @Id
    private String _id;
