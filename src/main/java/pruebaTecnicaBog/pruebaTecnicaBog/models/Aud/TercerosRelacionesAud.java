...
/**
 * Tabla que almacena la auditoria de tercerosRelaciones.
 * @author Manuel Fernando Barba Villamizar
 * @see pruebaTecnicaBog.pruebaTecnicaBog.models.TercerosRelaciones
 */

@Document(collection = "tercerosRelacionesAUD")
public class TercerosRelacionesAud {
    @Id
    private String _id;
