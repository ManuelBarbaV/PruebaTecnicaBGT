...
/**
 * Tabla que almacena la auditoria de listasTiposRelaciones.
 * @author Manuel Fernando Barba Villamizar
 * @see pruebaTecnicaBog.pruebaTecnicaBog.models.ListasTiposRelaciones
 */

@Document(collection = "listasTiposRelacionesAUD")
public class ListasTiposRelacionesAud {
    @Id
    private String _id;
