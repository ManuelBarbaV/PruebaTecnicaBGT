...
/**
 * Tabla que almacena la auditoria de terceros.
 * @author Manuel Fernando Barba Villamizar
 * @see pruebaTecnicaBog.pruebaTecnicaBog.models.Terceros
 */

@Document(collection = "tercerosAUD")
public class TercerosAud {
    @Id
    private String _id;
