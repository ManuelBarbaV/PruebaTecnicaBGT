...
/**
 * Tabla que almacena la auditoria de listasTiposEstadosCiviles.
 * @author Manuel Fernando Barba Villamizar
 * @see pruebaTecnicaBog.pruebaTecnicaBog.models.ListasTiposEstadosCiviles
 */

@Document(collection = "listasTiposEstadosCivilesAUD")
public class ListasTiposEstadosCivilesAud {
    @Id
    private String _id;
