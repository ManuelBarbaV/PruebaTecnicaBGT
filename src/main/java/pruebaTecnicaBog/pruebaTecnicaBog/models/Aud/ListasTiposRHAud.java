...
/**
 * Tabla que almacena la auditoria de listasTiposRH.
 * @author Manuel Fernando Barba Villamizar
 * @see pruebaTecnicaBog.pruebaTecnicaBog.models.ListasTiposRH
 */

@Document(collection = "listasTiposRHAUD")
public class ListasTiposRHAud {
    @Id
    private String _id;
